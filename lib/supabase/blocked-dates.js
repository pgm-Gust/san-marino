 ...
 */
export async function fetchBlockedDates(apartmentId = null, startDate = null, endDate = null) {
  try {
    let query = supabase
      .from("blocked_dates")
      .select("*")
 ...
 */
export async function addBlockedDate(apartmentId, startDate, endDate, reason = null) {
  try {
