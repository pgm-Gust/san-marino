...
export const metadata = {
  ...
  description:
    "Lees onze algemene voorwaarden voor het huren van een vakantiestudio in Middelkerke bij San Marino 4.",
};
...
export default function TermsPage() {
  const structuredData = {
    ...
    description:
      "Algemene voorwaarden voor het huren van een vakantiestudio in Middelkerke",
  };
